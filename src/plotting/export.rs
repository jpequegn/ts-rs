...
<svg width="{}" height="{}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="50%" y="65%" text-anchor="middle" font-family="Arial" font-size="12" fill="#666666">
        {} data points, {} series
    </text>
    <text x="50%" y="80%" text-anchor="middle" font-family="Arial" font-size="10" fill="#999999">
